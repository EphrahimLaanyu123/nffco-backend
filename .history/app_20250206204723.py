    ...
    def get(self):
     ...
     def delete(self, article_id):
        ...
        if article.approved:
            ...
            return {"message": "Article is not approved and cannot be deleted"}, 400
    
# Delete Approved Article Resource
class DeleteApprovedArticleResource(Resource):
    def delete(self, article_id):
        ...
        if not article.approved:
            return {"message": "Article is not approved"}, 400
        ...
        try:
            ...
            return {"message": "Error deleting article"}, 500

# Register the DELETE resource
...
api.add_resource(DeleteApprovedArticleResource, '/articles/approved/<int:article_id>/delete')
